...
function globalSettingsData() {
    return {
        ...
        whoweare_body_1: 'Ladex Group is a Germany-based procurement and supply company specializing in sourcing high-quality electrical, automation, and industrial equipment from leading European manufacturers.',
        whoweare_body_2: 'With operations in Germany and Nigeria, we combine direct access to Europe\'s manufacturing eco-system with on-ground technical support and delivery coordination across Africa and other international markets.',
        ...
        services_cta_heading: 'Ready to Source European Equipment?',
        services_cta_body: 'Tell us your requirements, specification and timeline. We handle the rest — from supplier identification to delivery.',
        ...
        why_us: [
            { icon: 'globe', title: 'Germany Based Access', description: 'Direct sourcing from European manufacturers and authorized distributors.' },
            { icon: 'graduation-cap', title: 'Engineering Expertise', description: 'Led by a qualified electrical engineer with international experience.' },
            { icon: 'map-pin', title: 'Local Presence in Nigeria', description: 'Strong on-ground support in Lagos and Ibadan.' },
            { icon: 'handshake', title: 'Customer Focus', description: 'End-to-end support from enquiry to delivery.' },
            { icon: 'package', title: 'Complete Service', description: 'From sourcing, logistics, and after-sales support.' },
        ],
    } as any;
}
...
function aboutPageData() {
    return {
        ...
        objectives_list: [
            { icon: 'globe', title: '', description: 'Supply genuine European equipment directly to industrial clients globally.' },
            { icon: 'trending-up', title: '', description: 'Bridge the gap between European manufacturers and international procurement teams.' },
            ...
            { icon: 'landmark', title: '', description: 'Act as a trusted technical representative for European manufacturers globally.' },
        ],
    } as any;
}
